...
namespace Battle.Tests.PathFinding
{
    ...
    public class PathFindingTests
    {
        ...
        public void Test_WithoutWalls_CanFindPath()
        {
            ...
            Path pathFinder = new(_searchParameters);
        ...
        private void InitializeMap(int xMax, int zMax, Point startingLocation, Point endLocation, bool locationsNotSet = true)
        {
            ...
            this._map = new string[xMax, zMax];
            ...
            this._searchParameters = new SearchParameters(startingLocation, endLocation, _map);
        }
